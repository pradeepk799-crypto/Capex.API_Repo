...
namespace Capex.Models.ResponseModel.Dashboard
{
    public class DashboardResponseModel : ResponseModelBase
    {
        public int? RoleID { get; set; }
        public int? TotalBuildingRegistered  { get; set; }
        public int TotalVendorRegistered { get; set; }
        public int? TotalNumberOfDDO { get; set; }
    ...
    public class DashboardVenderDistrictDetailsResponseModel : ResponseModelBase
    {
        public int? RoleID { get; set; }
    ...
    public class DashboardVenderDdoDetailsResponseModel : ResponseModelBase
    {
        public int? RoleID { get; set; }
    ...
    public class DashboardVenderBuildingDetailsResponseModel : ResponseModelBase
    {
        public int? RoleID { get; set; }
